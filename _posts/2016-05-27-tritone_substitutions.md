...
As you can see, you can fiddle about endlessly with chord extensions, and you can do this with the assurance that any extensions you add to a chord will still translate into something meaningful if you tritone-sub it.
...
Overall, tritone substitutions are useful in any form of modern popular or classical music. They can be written or ad-lib, and the thought processes behind them can be complex above and beyond what is discussed here, or as simple as 'leading down' into chord IV in the bass line. They provide a useful layer of abstraction to those trying to add interesting chord extensions, and help lift the harmony of the music, allowing the musician to add suspense and unpredictability to the listener's experience.
